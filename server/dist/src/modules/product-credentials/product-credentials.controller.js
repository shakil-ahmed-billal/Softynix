...
export class ProductCredentialsController {
     ...
     */
    getAllProductCredentials = asyncHandler(async (req, res) => {
     ...
     */
    getCredentialsByProductId = asyncHandler(async (req, res) => {
     ...
     */
    getCredentialsById = asyncHandler(async (req, res) => {
     ...
     */
    upsertProductCredentials = asyncHandler(async (req, res) => {
        ...
        const credentialsData = removeUndefined(credentialsDataRaw);
     ...
     */
    deleteProductCredentials = asyncHandler(async (req, res) => {
     ...
     */
    applyCredentialsToUsers = asyncHandler(async (req, res) => {
        const { id } = getProductCredentialsParamsSchema.parse(req.params);
        const credentials = await productCredentialsService.getCredentialsById(id);
...
//# sourceMappingURL=product-credentials.controller.js.map