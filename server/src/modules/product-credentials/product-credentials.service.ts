...
export class ProductCredentialsService {
   ...
   */
  async getAllProductCredentials(
   ...
   */
  async getCredentialsByProductId(productId: string): Promise<any | null> {
   ...
   */
  async getCredentialsById(id: string): Promise<any> {
   ...
   */
  async deleteProductCredentials(id: string): Promise<void> {
    const credentials = await prisma.productCredentials.findUnique({
      where: { id },
    });
   ...
   */
  async applyCredentialsToUsers(productId: string): Promise<number> {
    const credentials = await prisma.productCredentials.findUnique({
      where: { productId },
    });
